            ...
            <div class="card-body info-detail">
                <div class="left">
                    <a href="{{ route('get.product.detail',$product->pro_slug . '-'.$product->id ) }}" title=""
                       class="">
                        <img alt="" style="max-width: 100%;width: 100%;height: auto;max-height: 400px;" id="js-fill-img" src="{{ pare_url_file($product->pro_avatar) }}"
                             class="lazyload">
                    </a>
                ...
                <div class="right" id="product-detail" data-id="{{ $product->id }}">
                    ...
                    <div class="right__content">
                        <div class="info" style="width: 100%">
                            ...
                            <div class="btn-cart" style="max-width: 50%">
                            ...
                            <div class="infomation">
                                @if ($product->pro_description)
                                    <h2 class="infomation__title">Mô tả</h2>
        ...
        <div class="card-body product-des">
            ...
            <div class="right" style="margin-top: 20px">
                ...
                <a href="#" title="Giam giá" target="_blank">
                    <img alt="Hoan tien" style="width: 100%;height: 308px;"
