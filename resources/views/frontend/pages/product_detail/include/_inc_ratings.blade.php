<div class="reviews content_text">
    ...
    <div class="dashboards">
        ...
        <div class="item dashboards_btn">
            <a href="javascript:;void(0)" title="Gửi đánh giá"
               class="btn btn-success {{ \Auth::id() ? 'js-review' : 'js-show-login' }}">Gủi đánh giá</a>
        </div>
    </div>
    ...
    <div class="block-reviews" id="block-review">
        <form action="{{ route('ajax_post.user.rating.add') }}" id="form-review" method="POST">
            ...
            <div>
                <textarea name="content_review"  id="rv_content" cols="30" rows="5" placeholder="Nội dung "></textarea>
                <input type="hidden" name="review" id="review_value" value="5">
                <input type="hidden" name="product_id"  value="{{ $product->id }}">
            </div>
            <button type="submit" style="font-size: 14px;margin-top: 10px" class="btn btn-success js-process-review">Gủi đánh giá</button>
        </form>
    </div>
