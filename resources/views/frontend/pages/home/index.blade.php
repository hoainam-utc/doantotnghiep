                    ...
                    <div class="left">
                        <div class="image">
                            <a href="{{  $event1->e_link }}" title="" class="{{ $event1->e_name }} image" target="_blank">
                                <img style="height: 328px;" class="lazyload lazy" alt="{{ $event1->e_name }}" src="{{  asset('images/no-image.jpg') }}"  data-src="{{  pare_url_file($event1->e_banner) }}" />
                            </a>
                        </div>
                    </div>
                @endif
            ...
            <div class="container">
                <div class="banner" style="display: flex">
                    <div class="item" style="flex: 0 0 100%">
                        <a href="">
                            <img src="{{ asset('images/home-slide-1.jpeg') }}" alt="" style="width: 100%;height: 250px">
                        </a>
                    </div>
